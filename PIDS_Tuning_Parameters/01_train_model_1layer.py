...
def main():
    ...
    results_file = f"Results/{attack_type}_{feats}_1layer_results.txt"
    ...
    if load_model == "Load":
            model.load_state_dict(torch.load(f"Models/{attack_type}_{feats}_1layer.pth"))
    model.to(device)
    ...
    torch.save(model.state_dict(), f"Models/{attack_type}_{feats}_1layer.pth")
